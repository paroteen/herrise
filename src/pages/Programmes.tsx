...
export const Programmes: React.FC = () => {
  return (
    <div className="min-h-screen bg-white pb-20">
      <PageMeta title="Our Programmes" description="HerRise programmes: Economic Empowerment, Health Support, GBV Prevention, Education Support, and Leadership Development." />
