...
import { useIremboPay } from '@/services/iremboPay';
...
export const GetInvolved: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      <PageMeta title="Get Involved" description="Support HerRise through volunteering, donations, or in-kind support. Your time and resources can change lives." />
