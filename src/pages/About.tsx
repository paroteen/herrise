...
export const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      <PageMeta title="About Us" description="HerRise is a national NGO in Uganda committed to creating a society where women and girls are valued, respected, and empowered." />
      {/* Header */}
