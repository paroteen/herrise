...
export const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <PageMeta title="Home" description="HerRise Development Organisation empowers women and girls across Uganda through economic empowerment, health advocacy, and education." />
